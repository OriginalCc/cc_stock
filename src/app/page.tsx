...
import {
  Search, TrendingDown, Activity, ArrowUpRight, ArrowDownRight,
...
export default function StockTAssistant() {
  ...
  const [pageMode, setPageMode] = useState<"t-assistant" | "screener" | "intraday-screener" | "sector-rotation" | "early-screen" | "low-open" | "baota-deploy" | "limit-up-pullback">("t-assistant");
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <div className="flex items-center border border-border rounded-md overflow-hidden ml-1">
                {(["t-assistant", "screener", "low-open", "intraday-screener", "sector-rotation", "early-screen", "limit-up-pullback", "baota-deploy"] as const).map((mode) => (
