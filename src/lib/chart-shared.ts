...
export const CONDITION_LIBRARY: CustomFactorCondition[] = [
  ...
  // ── 放量下跌买点形态 ──
  { key: "macd_neg_near_peak", label: "MACD绿柱曾达峰值", description: "近20根内MACD柱为负且出现过峰值，空头动能曾释放", category: "indicator" },
  { key: "vol_dry_up_buy", label: "缩量到地量", description: "成交量降至均量50%以下，抛压衰竭", category: "volume" },
  { key: "price_near_lowest", label: "价格挨着最低价", description: "当前价格接近近期最低价（1%以内），底部区域", category: "price" },
];
